...
//  WeatherApp
//
//  Created by Raghavendra on 07/01/2017.
//  Copyright © 2017 Raghavendra. All rights reserved.
//
...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        let urlRequest = URLRequest(url: URL(string: "http://api.apixu.com/v1/current.json?key=1b1879a3a6c8dc2cfc6d8c48d62cc504=\(searchBar.text!.replacingOccurrences(of: " ", with: "%20"))")!)
